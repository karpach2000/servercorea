...
import com.parcel.tools.cards.CardsEvent
...
class CardsWebSocketController : TextWebSocketHandler() {
    ...
    private val cardsEventHandlers = ArrayList<CardsEventHandler>()
    ...
    class CardsEventHandler(private var session: WebSocketSession, private var name: String) : CardsEvent {
        ...
        override fun cardsIsNotSecretEvent(userCard: String) {
            sendMessage("spyIsNotSecretEvent$SEPORATOR$userCard")
        }
    ...
    override fun handleTextMessage(session: WebSocketSession, message: TextMessage) {
        ...
        if (command == "init") {
            ...
            CardsSessionManager.subscribeCardsSessionEvent(id, pas, CardsEventHandler(session, name))
